...
/**
 * Zawiera wszystkie ciągi tłumaczeń dla różnych logów aktywności.
 * Powinny być zgrupowane według wartości przed dwukropkiem (:)
 * w nazwie zdarzenia. Jeśli nie ma dwukropka, powinny znajdować się
...
return [
    'auth' => [
        ...
        'reset-password' => 'Poproszono o resetowanie hasła',
        'checkpoint' => 'Wymagana dwuskładnikowa autoryzacja',
        'recovery-token' => 'Użyto tokenu odzyskiwania dwuskładnikowego',
        'token' => 'Rozwiązano dwuskładnikowe wyzwanie',
        'ip-blocked' => 'Zablokowano żądanie z nienotowanego adresu IP dla :identifier',
        'sftp' => [
    ...
    'user' => [
        ...
        'two-factor' => [
            'create' => 'Włączono dwuskładnikowe uwierzytelnianie',
            'delete' => 'Wyłączono dwuskładnikowe uwierzytelnianie',
        ],
    ],
    'server' => [
        'reinstall' => 'Ponownie zainstalowano serwer',
        'console' => [
        ...
        'backup' => [
            ...
            'restore' => 'Przywrócono kopię zapasową :name (usunięto pliki: :truncate)',
            'restore-complete' => 'Zakończono przywracanie kopii zapasowej :name',
            'restore-failed' => 'Nie udało się przywrócić kopii zapasowej :name',
            'start' => 'Rozpoczęto nową kopię zapasową :name',
            'complete' => 'Oznaczono kopię zapasową :name jako ukończoną',
        ...
        'database' => [
            ...
            'rotate-password' => 'Zmieniono hasło do bazy danych :name',
        ...
        'file' => [
            ...
            'pull' => 'Pobrano plik zdalny z :url do :directory',
        ...
        'sftp' => [
            'denied' => 'Zablokowano dostęp do SFTP z powodu braku uprawnień',
            ...
            'rename_other' => 'Zmieniono lub przeniesiono :count plików',
        ],
        'allocation' => [
            'create' => 'Dodano :allocation do serwera',
            'notes' => 'Zaktualizowano notatki dla :allocation z ":old" na ":new"',
            'primary' => 'Ustawiono :allocation jako główne przypisanie serwera',
            'delete' => 'Usunięto przypisanie :allocation',
        ],
        'schedule' => [
        ...
        'subuser' => [
            'create' => 'Dodano :email jako subużytkownika',
            'update' => 'Zaktualizowano uprawnienia subużytkownika dla :email',
            'delete' => 'Usunięto :email jako subużytkownika',
        ],
    ],
];
